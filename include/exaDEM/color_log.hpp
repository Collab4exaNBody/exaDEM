...
// Text styles
inline std::string bold(const std::string& text) { return enable_colors() ? "\033[1m" + text + "\033[0m" : text; }
inline std::string underline(const std::string& text) { return enable_colors() ? "\033[4m" + text + "\033[0m" : text; }

// Foreground colors
inline std::string red(const std::string& text) { return enable_colors() ? "\033[31m" + text + "\033[0m" : text; }
inline std::string green(const std::string& text) { return enable_colors() ? "\033[32m" + text + "\033[0m" : text; }
inline std::string yellow(const std::string& text) { return enable_colors() ? "\033[33m" + text + "\033[0m" : text; }
inline std::string blue(const std::string& text) { return enable_colors() ? "\033[34m" + text + "\033[0m" : text; }
inline std::string magenta(const std::string& text) { return enable_colors() ? "\033[35m" + text + "\033[0m" : text; }
inline std::string cyan(const std::string& text) { return enable_colors() ? "\033[36m" + text + "\033[0m" : text; }
inline std::string white(const std::string& text) { return enable_colors() ? "\033[37m" + text + "\033[0m" : text; }
}  // namespace ansi
...
[[noreturn]] inline void mpi_error(const std::string& operator_name, const std::string& text) {
  int rank;
