...
cmd_awk() {
    local val=$1
		T2='$4'
		T8='$10'
		echo "awk 'FNR == 4 {print (${T2}-0.5)/0.98 \" \" ${T8} * (-1) / (0.98) }' "XYZFiles${val}"/*.xyz > "res_${val}.txt""
}
