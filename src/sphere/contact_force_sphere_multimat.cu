...
namespace exaDEM
{
  ...
  using namespace sphere;
	...
	template <bool cohesive, typename GridT, class = AssertGridHasFields<GridT, field::_vx, field::_vy, field::_vz, field::_mom, field::_orient, field::_vrot, field::_radius>> 
		class ComputeContactSphereMultiMat : public OperatorNode
	{
	...
	template <class GridT> using ComputeContactSphereMultiMatTmpl = ComputeContactSphereMultiMat<false, GridT>;
	template <class GridT> using ComputeContactSphereMultiMatCohesiveTmpl = ComputeContactSphereMultiMat<true, GridT>;
