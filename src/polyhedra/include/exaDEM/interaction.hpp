...
namespace exaDEM
{
	...
	struct Interaction
	{
		...
		{
			if( this->id_i == I.id_i && this->id_j == I.id_j && this->sub_i == I.sub_i &&	this->sub_j == I.sub_j)	return true;
			return false;
		}
		...
		{
			if( this->cell_i < I.cell_j)
			{
				return true;
			} 
			else if ( this->cell_i == I.cell_i && this->p_i < I.p_i)
			{
				return true;
			}
			else if ( this->cell_i == I.cell_i && this->p_i == I.p_i && this->sub_i < I.sub_i)
			{
				return true;
			}
			else if ( this->cell_i == I.cell_i && this->p_i == I.p_i && this->sub_i == I.sub_i && this->sub_j < I.sub_j)
			{
				return true;
			}
			else
