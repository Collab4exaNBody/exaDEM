...
namespace exaDEM
{
	...
	template<typename GridT
		...
		>
		class ComputeHookeInteractionBis : public OperatorNode
		{
...
#pragma omp for schedule(static)
	...
	template<class GridT> using ComputeHookeInteractionBisTmpl = ComputeHookeInteractionBis<GridT>;

	// === register factories ===  
	CONSTRUCTOR_FUNCTION
	{
		OperatorNodeFactory::instance()->register_factory( "compute_hooke_interactions_v2", make_grid_variant_operator< ComputeHookeInteractionBisTmpl > );
	}
}
