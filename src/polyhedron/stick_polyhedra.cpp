...
namespace exaDEM
{
  ...
  template <typename GridT, class = AssertGridHasFields<GridT, field::_cluster>> class StickPolyhedraOperator : public OperatorNode
  {
    ...
    ADD_SLOT(MultiMatParamsT<InnerBondParams>, multimat_ibp, INPUT, REQUIRED, DocString{"List of inner bond parameters for simulations with multiple materials"});
