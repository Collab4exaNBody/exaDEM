...
namespace exanb {
template <typename T>
struct ReduceCellParticlesTraits<exaDEM::ReduceMinFieldSet<T>> {
...
template <typename T, class FieldSetT, typename GridT>
class ReduceMinFieldOP : public OperatorNode {
...
using MinMassTmpl = ReduceMinFieldOP<double, field::_mass, GridT>;
template <class GridT>
using MinRxTmpl = ReduceMinFieldOP<double, field::_rx, GridT>;
template <class GridT>
using MinRyTmpl = ReduceMinFieldOP<double, field::_ry, GridT>;
template <class GridT>
using MinRzTmpl = ReduceMinFieldOP<double, field::_rz, GridT>;

// === register factories ===
ONIKA_AUTORUN_INIT(min_mass) {
  OperatorNodeFactory::instance()->register_factory("min_mass", make_grid_variant_operator<MinMassTmpl>);
}
ONIKA_AUTORUN_INIT(min_rx) {
  OperatorNodeFactory::instance()->register_factory("min_rx", make_grid_variant_operator<MinRxTmpl>);
}
ONIKA_AUTORUN_INIT(min_ry) {
  OperatorNodeFactory::instance()->register_factory("min_ry", make_grid_variant_operator<MinRyTmpl>);
}
ONIKA_AUTORUN_INIT(min_rz) {
  OperatorNodeFactory::instance()->register_factory("min_rz", make_grid_variant_operator<MinRzTmpl>);
}
