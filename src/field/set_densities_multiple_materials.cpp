...
// === register factories ===
ONIKA_AUTORUN_INIT(set_densities_multiple_materials) {
  OperatorNodeFactory::instance()->register_factory("set_densities_multiple_materials",
                                                    make_grid_variant_operator<SetDensities>);
}
