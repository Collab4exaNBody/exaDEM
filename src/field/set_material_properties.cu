...
// === register factories ===
ONIKA_AUTORUN_INIT(set_material_properties) {
  OperatorNodeFactory::instance()->register_factory("set_material_properties",
                                                    make_grid_variant_operator<SetMaterialProperties>);
}
}  // namespace exaDEM
