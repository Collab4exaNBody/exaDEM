...
class SetRandVelocity : public OperatorNode {
  ...
  using ComputeRegionFieldsVx =
      field_accessor_tuple_from_field_set_t<FieldSet<field::_rx, field::_ry, field::_rz, field::_id, field::_vx>>;
  using ComputeRegionFieldsVy =
      field_accessor_tuple_from_field_set_t<FieldSet<field::_rx, field::_ry, field::_rz, field::_id, field::_vy>>;
  using ComputeRegionFieldsVz =
      field_accessor_tuple_from_field_set_t<FieldSet<field::_rx, field::_ry, field::_rz, field::_id, field::_vz>>;
  using ComputeRegionFields = field_accessor_tuple_from_field_set_t<
      FieldSet<field::_rx, field::_ry, field::_rz, field::_id, field::_vx, field::_vy, field::_vz>>;
...
// === register factories ===
ONIKA_AUTORUN_INIT(set_rand_velocity) {
  OperatorNodeFactory::instance()->register_factory("set_rand_velocity",
                                                    make_grid_variant_operator<SetRandVelocity>);
}
}  // namespace exaDEM
