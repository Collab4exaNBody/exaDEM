...
namespace exaDEM
{
  ...
  template <typename GridT, class = AssertGridHasFields<GridT, field::_type, field::_radius, field::_mass, field::_orient>> class SetMaterialProperties : public OperatorNode
  {
