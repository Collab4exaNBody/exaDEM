...
namespace exaDEM
{
  ...
  template <typename GridT, class = AssertGridHasFields<GridT, field::_type>> class ParticleType : public OperatorNode
  {
  ...
  template <class GridT> using ParticleTypeTmpl = ParticleType<GridT>;

  // === register factories ===
  ONIKA_AUTORUN_INIT(particle_type) { OperatorNodeFactory::instance()->register_factory("particle_type", make_grid_variant_operator<ParticleTypeTmpl>); }
