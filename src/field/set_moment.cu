...
template <typename GridT, class = AssertGridHasFields<GridT, field::_mom>>
class SetMoment : public OperatorNode {
...
// === register factories ===
ONIKA_AUTORUN_INIT(set_moment) {
  OperatorNodeFactory::instance()->register_factory("set_moment", make_grid_variant_operator<SetMoment>);
}
