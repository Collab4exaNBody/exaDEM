...
class CompressInteraction : public OperatorNode {
 ...
 public:
  inline std::string documentation() const final {
    return R"EOF(
        This opertor compress interaction by removing inactive interaction.
        Do not use it if interaction are not rebuilt after.
  ...
  inline void execute() final {
    ...
    auto save = [](const PlaceholderInteraction& interaction) -> bool {
