...
namespace exanb
{
  template <> struct ReduceCellParticlesTraits<exaDEM::ReduceStressTensorFunctor>
  {
...
namespace exaDEM
{
  ...
  template <typename GridT, class = AssertGridHasFields<GridT, field::_stress>> class AverageStressTensor : public OperatorNode
  {
