...
namespace exaDEM
{
  ...
  template <typename GridT, class = AssertGridHasFields<GridT, field::_rx, field::_ry, field::_rz>> class AverageStressTensor : public OperatorNode
  {
...
#       pragma omp critical
  ...
  // === register factories ===
  CONSTRUCTOR_FUNCTION { OperatorNodeFactory::instance()->register_factory("average_stress_tensor", make_grid_variant_operator<AverageStressTensorTmpl>); }
} // namespace exaDEM
