...
namespace onika {
namespace parallel {
template <exaDEM::InteractionType IT, typename K, typename A, typename... Args>
struct ParallelForFunctorTraits<exaDEM::WrapperContactLawForAll<IT, K, A, Args...>> {
  static inline constexpr bool RequiresBlockSynchronousCall = false;
  static inline constexpr bool CudaCompatible = true;
};

template <exaDEM::InteractionType IT, typename K, typename... Args>
struct ParallelForFunctorTraits<exaDEM::WrapperForAll<IT, K, Args...>> {
  static inline constexpr bool RequiresBlockSynchronousCall = false;
  static inline constexpr bool CudaCompatible = true;
};
}  // namespace parallel
