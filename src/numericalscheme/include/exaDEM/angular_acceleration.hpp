...
struct PushToAngularAccelerationFunctor {
  ...
  inline void operator()(const exanb::Quaternion& Q, const exanb::Vec3d& mom,
                         const exanb::Vec3d& vrot, exanb::Vec3d& arot,
...
namespace exanb {
template <>
struct ComputeCellParticlesTraits<exaDEM::PushToAngularAccelerationFunctor> {
