...
class DumpReaderConfRockable : public OperatorNode {
  ...
  inline std::string documentation() const final {
    return R"EOF(
         This operator reads a rockable output file.
         However, some lines are not processed by the reader, such as the contact law type or its parameters.
