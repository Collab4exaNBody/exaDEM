...
using namespace exanb;
  ...
  public:
    ...
    inline void execute () override final
    {
      ...
      double conv_energy = 1.e4 * legacy_constant::atomicMass;
     ...
     static const std::string header = "     Step     Time (ps)     Particles   Mv/Ext/Imb.  Tot. E. (J/part)  Kin. E. (J/part)  Pot. E. (J/part)  Temperature   Pressure     sMises     Volume       Mass  Part/timestep/s";
      ...
      *lb_inbalance_max = 0.0;
      ...
      lout<<format_string("%9ld % .6e %13ld  %c %c %8s  % .10e  % .10e  % .10e  % 11.3f % .3e % .3e % .3e % .3e % .3e",
	  *timestep,
	  *physical_time,
