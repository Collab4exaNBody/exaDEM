...
namespace exaDEM
{
  ...
  class SimDumpReadParticles : public OperatorNode
  {
    ...
    ADD_SLOT( bool        , enable_friction , INPUT , true );
...
//    ADD_SLOT( ParticleSpecies , species , INPUT_OUTPUT , REQUIRED );
  ...
  public:
    inline void execute () override final
    {
      ...
      dump_filter.enable_friction = *enable_friction;
  ...
  {
    OperatorNodeFactory::instance()->register_factory( "read_dump_particles" , make_grid_variant_operator<SimDumpReadParticles> );
  }
