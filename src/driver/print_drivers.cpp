...
namespace exaDEM
{
  ...
  template<class GridT> using PrintDriversTmpl = PrintDrivers<GridT>;

  // === register factories ===  
  CONSTRUCTOR_FUNCTION
  {
    OperatorNodeFactory::instance()->register_factory( "print_drivers", make_grid_variant_operator< PrintDriversTmpl > );
  }
}
