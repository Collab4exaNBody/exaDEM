...
struct Surface {
  ...
  /**
   * @brief Converts net forces into scalar acceleration along the compression axis.
   * @param motion  Driver parameters: mass, motion vector.
   */
  ...
  /**
   * @brief Updates particle velocity based on the driver motion type.
   * @param motion  Driver parameters (motion vector, constant velocity, etc.).
   * @param dt      Effective time step (dt × dt_scale).
   */
